                ...
                <div className="mx-auto max-w-7xl sm:px-6 lg:px-8 space-y-8">
                        ...
                        <div className="bg-gradient-to-r from-[#FF7A00] to-[#FF9900] rounded-3xl p-8 md:p-12 text-white shadow-xl shadow-orange-200/50 relative overflow-hidden group">
                            ...
                            <div className="relative z-10 max-w-2xl">
                                ...
                                <div className="flex flex-col sm:flex-row items-start sm:items-center gap-6">
                                    <Link 
                                        href={route('courses.learn', [resume.course.id, resume.lesson?.id])}
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                        <div className="bg-white dark:bg-gray-800 p-8 rounded-3xl shadow-sm border border-gray-100 dark:border-gray-700 relative overflow-hidden group">
                            ...
                            <p className="text-4xl font-black text-gray-900 dark:text-gray-100">{currentStats.total_enrolled}</p>
                        </div>
                        ...
                        <div className="bg-white dark:bg-gray-800 p-8 rounded-3xl shadow-sm border border-gray-100 dark:border-gray-700 relative overflow-hidden group">
                            ...
                            <p className="text-4xl font-black text-gray-900 dark:text-gray-100">{currentStats.total_completed_lessons}</p>
                        </div>
                        ...
                        <div className="bg-white dark:bg-gray-800 p-8 rounded-3xl shadow-sm border border-gray-100 dark:border-gray-700 relative overflow-hidden group">
                            ...
                            <p className="text-4xl font-black text-gray-900 dark:text-gray-100">{currentStats.certificates}</p>
                        </div>
                    </div>
                    ...
                    <div className="bg-white dark:bg-gray-800 rounded-[2.5rem] shadow-xl shadow-gray-100/50 dark:shadow-none border border-gray-50 dark:border-gray-700 overflow-hidden">
                        <div className="p-8 md:p-12">
                            <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6 mb-10">
                                <div>
                                    <h3 className="text-2xl font-black text-gray-900 dark:text-white mb-2">My Courses</h3>
                                    <p className="text-gray-500">Track your progress and continue learning.</p>
                                </div>
                                <a href="/courses" className="px-8 py-3 bg-gray-900 dark:bg-white dark:text-gray-900 text-white rounded-2xl font-bold text-sm shadow-lg shadow-gray-200 dark:shadow-none hover:-translate-y-1 transition-all">
                                    Browse More Courses
                                </a>
                            </div>
                                    ...
                                    courses.map((course) => (
                                        <div key={course.id} className="bg-gray-50 dark:bg-gray-900/50 rounded-3xl p-6 border border-gray-100 dark:border-gray-800 group hover:shadow-xl hover:shadow-orange-100/20 transition-all duration-300">
                                            ...
                                            <p className="text-[10px] text-gray-400 font-bold uppercase tracking-widest mb-4">Mentor: {course.mentor?.name}</p>
                                                <div className="flex items-center gap-2 mt-4 pt-4 border-t border-gray-200/50 dark:border-gray-800">
